...
import io.agora.tutorials1v1vcall.util.FileUtil;
...
public class VideoListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (fileUtil != null) {
                    fileUtil.deleteAll(new File(/*fileUtil.getCacheDir(getApplication()) +*/ "/sdcard/" + url + "/"));
                }
            }
        });
    ...
    private File[] getAllAdFile() {
        File file = new File(/*new FileUtil().getCacheDir(this)*/"/sdcard/", "/" + url + "/");
