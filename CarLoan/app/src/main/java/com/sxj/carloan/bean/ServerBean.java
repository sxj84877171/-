 ...
 */
    ...
    public static class RowsBean implements Serializable {
        ...
        private int user_id_ds = -1;
        private int gps_state_id = -1;
        ...
        private int user_id_bgnq_info = -1;
        private String commercial_insurance_return;
        private int fk_zg_result_id = -1;
        private int ds_result_id = -1;
        private String loan_amount_ywy_low_1;
        private String yw_sp_info;
        private int nq_state_id = -1;
        private int if_need_yw_sp = -1;
        ...
        private int user_id_zh_lk = -1;
        private String fk_zg_info;
        private int outcome_salary = -1;
        private int user_id_fee_cw = -1;
        private String fk_info;
        private int user_id_certificate = -1;
        ...
        private int user_id_car_photo = -1;
        private String date_sh;
        private String zh_sh_yh_jl2;
        private int cw_sk_result_id = -1;
        private int user_id_zh_sh = -1;
        private int yw_sp_result_id = -1;
        private String loan_amount_dcy;
        private String cust_mobile;
        private int user_id_fk_zg = -1;
        private int user_id_zhengxin = -1;
        private String car_type;
        private int report_state_id = -1;
        private String date_dcy_yw;
        private int zhengxin_result_id = -1;
