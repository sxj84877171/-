...
public class ICBCHalf36ProductCalc implements IProductCalc {

    private ServerBean.RowsBean rowsBean;

    public ICBCHalf36ProductCalc(ServerBean.RowsBean rowsBean) {
    ...
    /**
     * 获取月供
     * loan_amount_ywy * 1.09 / 36 * 10000
     *
     * @return
     */
    @Override
    public double getYueGong() {
        Double ywy = Double.parseDouble(rowsBean.getLoan_amount_ywy());
        return ywy * 1.09 / 36 * 10000;
    }
    ...
    public double getHeJi() {
        double deposit = getBaoZhengJin();
        double interest_company = Double.parseDouble(getInterest_company());
        double extras_fee = getTiaoZhengXiang();
        double gps_fee = getGpsFei();
        double evaluation_fee = Double.parseDouble(getEvaluationFee());
        double mortgage_fee = getDiYaFei();
        return deposit + interest_company + extras_fee + gps_fee + evaluation_fee + mortgage_fee;
    }
    ...
    public String getInterest_company() {
        Double loan_amount_ywy = Double.parseDouble(rowsBean.getLoan_amount_ywy());
        double evaluation_fee = Double.parseDouble(getEvaluationFee());
        return loan_amount_ywy * 0.098 * 10000 - getGpsFei() - evaluation_fee - getDiYaFei() + "";
    }
