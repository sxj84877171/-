...
public class ICBCUsedCar12Whole36M2448BPart extends ProductType {
    /**
     * 获取产品名字
     *
     * @return
    ...
    public double getLoanAmountYwyCorp() {
        return loanAmountYwyCory;
    }

    private double loanAmountYwyCory;

    public void setLoanAmountYwyCory(double loanAmountYwyCory) {
        this.loanAmountYwyCory = loanAmountYwyCory;
    }
    ...
    public ICBCUsedCar12Whole36M2448BPart(double loan_amount_ywy) {
        super(loan_amount_ywy);
    }

    /**
     * 前置利息
     * interest_company=(loan_amount_ywy*0.1548+loan_amount_ywy_corp*1.2448)*10000
     *
     * @return
     */
    @Override
    public double getInterestCompany() {
        double interest_company = (getLoan_amount_ywy() * 0.1548 + getLoanAmountYwyCorp() * 1.2448) * 10000;
    ...
    public double getPaybackMonth12() {
        double payback_month_12 = getPaybackMonth() + ((getLoan_amount_ywy() * 0.1548 + getLoanAmountYwyCorp() * 1.2448) * 10000) / 12.0;
    ...
    public double getFeeReturnAgency() {
        double fee_return_agency = (getLoan_amount_ywy() + getLoanAmountYwyCorp()) * 0.04 * 10000;
    ...
    public double getFeeTotal() {
        double fee_total = getPaybackMonth12() - getFeeReturnAgency() + getExtrasFee();
