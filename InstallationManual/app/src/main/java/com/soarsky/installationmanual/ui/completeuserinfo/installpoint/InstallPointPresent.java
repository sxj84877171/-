...
public class InstallPointPresent extends BasePresenter<InstallPointModel,InstallPointView> {
     ...
     * @return
     */
    public void getInstallPoint(final String code){

        mView.showProgess();
        mModel.getInstallPoint(code).subscribe(new Subscriber<ResponseDataBean<List<InPoBean>>>() {
            @Override
            ...
            @Override
            public void onNext(ResponseDataBean<List<InPoBean>> loginParam) {
                mView.stopProgess();
