...
public class VehicleAdministrationModel implements BaseModel {
     ...
     * @return
     */
    public Observable<ResponseDataBean<List<VeAdBean>>> getManageCar(final String code){
        return Api.getInstance().service.getManageCar(code).compose(RxSchedulers.<ResponseDataBean<List<VeAdBean>>>io_main());
    }
