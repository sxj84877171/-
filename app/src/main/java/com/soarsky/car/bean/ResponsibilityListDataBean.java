...
public class ResponsibilityListDataBean {
    /**
     * 地址
     */
     ...
     * 本方最终认定结果
     */
    private String firstFinalAffirm;

    /**
     * 对方最终认定结果
     */
    private String secondFinalAffirm;
    ...
    public String getFirstFinalAffirm() {
        return firstFinalAffirm;
    }

    public void setFirstFinalAffirm(String firstFinalAffirm) {
        this.firstFinalAffirm = firstFinalAffirm;
    }

    public String getSecondFinalAffirm() {
        return secondFinalAffirm;
    }

    public void setSecondFinalAffirm(String secondFinalAffirm) {
        this.secondFinalAffirm = secondFinalAffirm;
    }
}
