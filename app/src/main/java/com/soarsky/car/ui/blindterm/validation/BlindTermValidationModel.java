...
public class BlindTermValidationModel implements BaseModel{
     ...
     * @return
     */
    public Observable<LicensePwdParam> setQueryPwd(BlindTermValidSendParam param){
        return Api.getInstance().service.setQueryPwd(param.getUsername(),param.getQueryPwd()).compose(RxSchedulers.<LicensePwdParam>io_main());
    }
