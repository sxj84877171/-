...
public class IWantBorrowPresent extends BasePresenter<IWantBorrowMedol,IWantBorrowView> {
    ...
    public void borrowCar(String carNum,String phoneNum,String startTime,String endTime,String borrowPhone){
       mView.showProgess();
       mModel.borrow(carNum,phoneNum,startTime,endTime,borrowPhone).subscribe(new Subscriber<BorrowParm>() {
            @Override
            ...
            @Override
            public void onNext(BorrowParm borrowParm) {
                mView.stopProgess();
    ...
    public void check(String carNum,String phone){
        mView.showProgess();
        mModel.check(carNum,phone).subscribe(new Subscriber<CheckBorrowCar>() {
            @Override
            public void onCompleted() {
            ...
            @Override
            public void onNext(CheckBorrowCar checkBorrowCar) {
                mView.stopProgess();
