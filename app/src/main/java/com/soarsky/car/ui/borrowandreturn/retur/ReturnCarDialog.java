...
public class ReturnCarDialog extends Dialog {
    ...
    public ReturnCarDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public ReturnCarDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final ReturnCarDialog dialog = new ReturnCarDialog(context, R.style.Dialog);
            View layout = inflater.inflate(R.layout.dialog_return_car, null);
