...
package com.soarsky.car.ui.borrowandreturn.wheelview;
...
public class WheelView extends View {
	...
	/** 当前值与标签文本颜色 */
	private static final int VALUE_TEXT_COLOR = 0x8F000000;

	/** 项目文本颜色 */
	private static final int ITEMS_TEXT_COLOR = 0xFFDADADA;
