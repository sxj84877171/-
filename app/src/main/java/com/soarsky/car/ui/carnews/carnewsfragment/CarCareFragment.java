...
public class CarCareFragment extends BaseFragment<CarCarePresent,CarCareModel> implements CarCareView ,View.OnClickListener {
    /**
     * 资讯列表
     */
     ...
     * 未读文章的id的集合
     */
    private List<String> noReadIdList = new ArrayList<String>();
    ...
    public List<String> getNoReadIdList() {
        return noReadIdList;
    }
    @Override
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.latest_read:
                //String read = SPUtils.getString(mContext,READ,Constants.LATEST_READ);
            ...
            case R.id.ll_search:
                ...
                i.putExtra("type", Constants.TYPE_CAR_CARE);
                startActivity(i);
    ...
    public void showSuccess(ResponseDataBean<List<AutomotiveInfo>> listResponseDataBean) {
        ...
        for(int i=0;i<mList.size();i++){
            if(idList.contains(mList.get(i).getId())){
                ...
                noReadIdList.add(mList.get(i).getId()+"");
                noReadCount = noReadIdList.size();
            }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                //SPUtils.putString(mContext,READ,String.valueOf(mList.get(i).getId()));
    ...
    public void onStart() {
        ...
        mPresenter.getAutomotiveList(Constants.TYPE_CAR_CARE);
    }
