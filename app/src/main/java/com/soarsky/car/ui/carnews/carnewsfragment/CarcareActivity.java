...
public class CarcareActivity extends BaseActivity<CarCarePresent,CarCareModel> implements CarCareView, View.OnClickListener {
    /**
     * 返回按钮
     */
    ...
    public void initView() {
        ...
        titleTv.setText(getString(R.string.car_care));
    ...
    public void showError(Throwable e) {
        ToastUtil.show(CarcareActivity.this,R.string.no_connet_internet);
    }
    ...
    public void showSuccess(ResponseDataBean<List<AutomotiveInfo>> listResponseDataBean) {
        ...
        adapter = new CarCareFragmentAdapter(CarcareActivity.this);
