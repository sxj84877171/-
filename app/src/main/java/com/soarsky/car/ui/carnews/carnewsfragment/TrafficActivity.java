...
public class TrafficActivity extends BaseActivity<CarCarePresent,CarCareModel> implements CarCareView, View.OnClickListener {
    /**
     * 返回按钮
     */
    ...
    public void initView() {
        ...
        titleTv.setText(getString(R.string.traffic_safe));
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPresenter.getAutomotiveList(Constants.TYPE_TRAFFIC_SAFE);
    }
    ...
    public void showError(Throwable e) {
        ToastUtil.show(TrafficActivity.this,R.string.no_connet_internet);
    }
    ...
    public void showSuccess(ResponseDataBean<List<AutomotiveInfo>> listResponseDataBean) {
        ...
        adapter = new CarCareFragmentAdapter(TrafficActivity.this);
