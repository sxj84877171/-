...
public class ResponsibilityListActivty extends BaseActivity<ResponsibilityListPresent,ResponsibilityListModel> implements ResponsibilityListView, View.OnClickListener {
    ...
    public void getFastListSuccess(ResponsibilityListParam responsibilityListParam) {
        if(responsibilityListParam != null){
            if("0".equals(responsibilityListParam.getStatus())){
                recyclerViewAdapter = new RecyclerViewAdapter(this,responsibilityListParam.getData());
                ...
                ToastUtil.show(this,responsibilityListParam.getMessage());
            }
        }
    }
