...
import com.soarsky.car.bean.ResponsibilityDetailsParam;
...
public class ResponsibilityDetailsPresent extends BasePresenter<ResponsibilityDetailsModel,ResponsibilityDetailsView> {
    ...
    public void getFastInfo(String id){
        ...
        mModel.getFastInfo(id).subscribe(new Subscriber<ResponseDataBean<ResponsibilityListDataBean>>() {
            @Override
            ...
            @Override
            public void onNext(ResponseDataBean<ResponsibilityListDataBean> responsibilityDetailsParam) {
