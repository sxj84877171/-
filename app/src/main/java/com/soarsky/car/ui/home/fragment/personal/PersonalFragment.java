...
//                亲情号码
    ...
    @Override
    public void showSuccess(QueryFamilyParam param) {
        ...
        if(param != null){
            if("0".equals(param.getStatus())){
                ...
                if(param.getData().getIlist().size()>0) {
                    ...
                    List<QueryFamilyParam.DataBean.IlistBean> _list = new ArrayList<QueryFamilyParam.DataBean.IlistBean>();
//                  剔除车主号码
                    for (QueryFamilyParam.DataBean.IlistBean bean:param.getData().getIlist()){
     ...
     * @param list
     */
    private void insertFamilyNum(List<QueryFamilyParam.DataBean.IlistBean> list){
        for (QueryFamilyParam.DataBean.IlistBean bean:list){
