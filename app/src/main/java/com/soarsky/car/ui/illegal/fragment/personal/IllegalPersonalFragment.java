 ...
 * 邮编：410000<br>
 * 程序功能：根据车牌号获取违章信息<br>
 * 该类为 IllegalPersonalFragment<br>
 */


public class IllegalPersonalFragment extends BaseFragment<IllegalPersonalFragmentPresent,IllegalPersonalFragmentModel> implements IllegalPersonalFragmentView,View.OnClickListener,IllegalUpdateCallBack{
            ...
            if(Constants.REQUEST_SUCCESS.equals(param.getStatus())){
                ...
                illegalListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        if(Constants.NO_REVOKE.equals(bean.getSign())){

                            if(Constants.REVOKEING.equals(bean.getStatus())||Constants.REVOKED.equals(bean.getStatus())){
...
//                illegaldealCentTv.setText(""+param.getData().getCountCent());
    ...
    public void illegalUpdateCallBack(String id) {
        Log.d("TAG","IllegalPersonFragment---illegalUpdateCallBack");
