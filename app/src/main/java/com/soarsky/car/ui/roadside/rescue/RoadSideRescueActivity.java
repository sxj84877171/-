...
//                mPresenter.gotoRoadSideOrder();
    ...
    public void getCarTypeSuccess(RoadSideCarTypeParam roadSideCarTypeParam) {
        ...
        if(roadSideCarTypeParam != null){
            ...
            if("0".equals(roadSideCarTypeParam.getStatus())){

                List<RoadSideCarTypeParam.DataBean> list = roadSideCarTypeParam.getData();
                for (RoadSideCarTypeParam.DataBean bean:list){
                    carType_list.add(bean.getDtext());
                }

            }else {
                ToastUtil.show(this,roadSideCarTypeParam.getMessage());
            }
        }
    ...
    public void uploadResouseSuccess(RoadSideRescueParam roadSideRescueParam) {
        ...
        if(roadSideRescueParam != null){
            if("0".equals(roadSideRescueParam.getStatus())){
    ...
    public boolean verifyData() {
        ...
        if(TextUtils.isEmpty(road_side_rescue_carnumEt.getText().toString())){
