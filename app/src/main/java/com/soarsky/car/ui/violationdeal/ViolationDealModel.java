...
public class ViolationDealModel implements BaseModel{
     ...
     * @return
     */
    public Observable<ViolationDealParam> violationDeal(ViolationDealSendParam param){
        return Api.getInstance().service.violationDeal(param.getCarnum()).compose(RxSchedulers.<ViolationDealParam>io_main());
    }
}
