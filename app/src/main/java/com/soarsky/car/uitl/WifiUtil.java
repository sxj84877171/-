 ...
 * 公司地址（Add）  ：湖南省长沙市岳麓区麓谷信息港A座8楼<br><br>
 * 版本：1.0.0.0<br>
 * 邮编：410000<br>
 * 程序功能：<br>
 * Wifi工具类<br>
...
//        int preLength = 24;
//        String getWay = "192.168.43.254";
//        String dns1 = "192.168.43.254";
//
//        new StaticIpSet(App.getApp(), ipAddress, preLength, getWay, dns1).confingStaticIp(config);
     ...
     *
     */
    public void removeNetWorkId(String  ssid) {
    ...
    public int getCurrentnetId() {
        ...
        if (wifiInfo != null && isWifiConnected()) {
            LogUtil.i("当前的netID" + wifiInfo.getNetworkId());
    ...
    public void recoverWifi() {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                connectWifi(App.getApp().getNetId());
