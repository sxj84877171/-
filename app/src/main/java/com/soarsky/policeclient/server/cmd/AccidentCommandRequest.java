 ...
 * 向智能终端发送电子罚单命令<br>
 */
public class AccidentCommandRequest extends BaseCmd {

    /**
     * 电子罚单指令
     */
    private static final int ELECTRONIC_TICKET = 0x0005;

    /**
     * 电子罚单指令
     */
    public AccidentCommandRequest() {
     ...
     * @param msg
     */
    public AccidentCommandRequest(String msg) {
        this();
     ...
     */
    public AccidentCommandRequest(String carNum, int length, String content) {
     ...
     * @param type 电子罚单内容
     */
    public AccidentCommandRequest(String carNum, String type) {
        this();
        setElectronicMsg(carNum + type);
    }
