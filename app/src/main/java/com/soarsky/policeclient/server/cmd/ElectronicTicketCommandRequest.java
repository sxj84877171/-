 ...
 * 向智能终端发送电子罚单命令<br>
 */
public class ElectronicTicketCommandRequest extends BaseCmd {

    /**
     * 电子罚单指令
     */
    private static final int ELECTRONIC_TICKET = 0x0003;

    /**
     * 电子罚单指令
     */
    public ElectronicTicketCommandRequest() {
     ...
     * @param msg
     */
    public ElectronicTicketCommandRequest(String msg) {
        this();
     ...
     */
    public ElectronicTicketCommandRequest(String carNum, int length, String content) {
     ...
     * @param content 电子罚单内容
     */
    public ElectronicTicketCommandRequest(String carNum, String content) {
        this();
        /*setElectronicMsg(carNum + correntLength(content.getBytes().length) + content);*/
