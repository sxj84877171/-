...
public class BlackListCarDetailsModel implements BaseModel{


    public Observable<ResponseDataBean<Void>> dealBlack(String carnum,String ptype,String username){
        return ApiM.getInstance().service.dealBlack(carnum,ptype,username).compose(RxSchedulers.<ResponseDataBean<Void>>io_main());
    }
