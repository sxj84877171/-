 ...
 * 该类为 开电子罚单横向滚动图片<br>
 */
public class ViolationHorizontalScrollView extends HorizontalScrollView implements
		OnClickListener
{
	...
	public ViolationHorizontalScrollView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		// 获得屏幕宽度
